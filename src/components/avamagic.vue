    ...
    <v-layout row wrap>
      <v-flex xs12 sm10 offset-sm1 md10 offest-md1 lg10 offset-lg1>
        <v-toolbar flat color="grey lighten-2">
          ...
          <download-excel :data="json_data" :fields="json_fields" type="csv" :name="fileName" :fetch="downloadExcelUsageTraker">
        ...
        <div class="table-responsive">
          <table class="table table-hover table-bordered" v-if="show">
            ...
            <tr class="grey lighten-2">
              ...
              <td width="10%" class="text-xs-center" scope="col"></td>
              <td width="14%" class="text-xs-center" scope="col" colspan="2">New OPD</td>

              <td width="35%" class="text-xs-center" scope="col" colspan="5">Perimeter (Count)</td>

              <td width="14%" class="text-xs-center" scope="col" colspan="2">Perimeter (Revenue) </td>

            </tr>


            <tr class="grey lighten-2">
              <td class="text-xs-center" width="10%" scope="col">Entity</td>
              <td width="10%" class="text-xs-center" scope="col">Region</td>
              <td width="10%" class="text-xs-center" scope="col">Branch</td>
              <td width="7%" class="text-xs-center" scope="col">FTD</td>
              <td width="7%" class="text-xs-center" scope="col">MTD</td>
              <td width="7%" class="text-xs-center" scope="col">Advised</td>
              <td width="7%" class="text-xs-center" scope="col">FTD</td>
              <td width="7%" class="text-xs-center" scope="col">MTD</td>
              <td width="7%" class="text-xs-center" scope="col">Target</td>
              <td width="7%" class="text-xs-center" scope="col">Tar Ach%</td>
              <td width="7%" class="text-xs-center" scope="col">FTD</td>
              <td width="7%" class="text-xs-center" scope="col">MTD</td>
            </tr>
            ...
            <tbody>
              ...
              <tr scope="row" v-for="(item,index) in aeh_chennai_branches" :key="index+item.branch" class="grey lighten-4">
                <td width="10%" scope="row" class="text-xs-center">{{item.entity}}</td>
                <td width="10%" scope="row" class="text-xs-center">Chennai</td>
                <td width="10%" scope="row" class="text-xs-center">{{item.branch}}</td>
                <td width="7%" scope="row" class="text-xs-center">{{item.ftdopdrev}}</td>
                <td width="7%" scope="row" class="text-xs-center">{{item.mtdopdrev}}</td>
                <td width="7%" scope="row" class="text-xs-center"></td>
                <td width="7%" scope="row" class="text-xs-center">0</td>
                <td width="7%" scope="row" class="text-xs-center">0</td>
                <td width="7%" scope="row" class="text-xs-center">{{item.target}}</td>
                <td width="7%" scope="row" class="text-xs-center">0</td>
                <td width="7%" scope="row" class="text-xs-center">{{item.revenueftdamount}}</td>
                <td width="7%" scope="row" class="text-xs-center">{{item.revenuemtdamount}}</td>
              ...
              <tr scope="row" v-for="(item,index) in ahc_chennai_branches" :key="index+item.branch" class="grey lighten-4">
                ...
                <td width="7%" scope="row" class="text-xs-center">0</td>
                <td width="7%" scope="row" class="text-xs-center">{{item.target}}</td>
                <td scope="row" class="text-xs-center">0</td>
                <td width="7%" scope="row" class="text-xs-center">{{item.revenueftdamount}}</td>
                <td width="7%" scope="row" class="text-xs-center">{{item.revenuemtdamount}}</td>
              ...
              <tr scope="row" v-for="(item,index) in aeh_rotn_branches" :key="index+item.branch" class="grey lighten-4">
                <td width="10%" scope="row" class="text-xs-center">{{item.entity}}</td>
                <td width="10%" scope="row" class="text-xs-center">ROTN</td>
                <td width="10%" scope="row" class="text-xs-center">{{item.branch}}</td>
                <td width="7%" scope="row" class="text-xs-center">{{item.ftdopdrev}}</td>
                <td width="7%" scope="row" class="text-xs-center">{{item.mtdopdrev}}</td>
                <td width="7%" scope="row" class="text-xs-center">{{item.advise}}</td>
                <td width="7%" scope="row" class="text-xs-center">{{item.revenueftdcount}}</td>
                <td width="7%" scope="row" class="text-xs-center">{{item.revenuemtdcount}}</td>
                <td width="7%" scope="row" class="text-xs-center">{{item.target}}</td>
                <td scope="row" class="text-xs-center">{{item.revenuetargetachived}}</td>
                <td width="7%" scope="row" class="text-xs-center">{{item.revenueftdamount}}</td>
                <td width="7%" scope="row" class="text-xs-center">{{item.revenuemtdamount}}</td>
              ...
              <tr scope="row" v-for="(item,index) in ahc_rotn_branches" :key="index+item.branch" class="grey lighten-4">
                <td width="10%" scope="row" class="text-xs-center">{{item.entity}}</td>
                <td width="10%" scope="row" class="text-xs-center">ROTN</td>
                <td width="10%" scope="row" class="text-xs-center">{{item.branch}}</td>
                <td width="7%" scope="row" class="text-xs-center">{{item.ftdopdrev}}</td>
              ...
              <tr scope="row" v-for="(item,index) in banglore_branches" :key="index+item.branch" class="grey lighten-4">
                <td width="10%" scope="row" class="text-xs-center">{{item.entity}}</td>
                <td width="10%" scope="row" class="text-xs-center">Banglore</td>
                <td width="10%" scope="row" class="text-xs-center">{{item.branch}}</td>
                <td width="7%" scope="row" class="text-xs-center">{{item.ftdopdrev}}</td>
                <td width="7%" scope="row" class="text-xs-center">{{item.mtdopdrev}}</td>
                <td width="7%" scope="row" class="text-xs-center">{{item.advise}}</td>
                ...
                <td width="7%" scope="row" class="text-xs-center">{{item.revenuemtdcount}}</td>
                <td width="7%" scope="row" class="text-xs-center">{{item.target}}</td>
                <td width="7%" scope="row" class="text-xs-center">{{item.revenuetargetachived}}</td>
                <td width="7%" scope="row" class="text-xs-center">{{item.revenueftdamount}}</td>
                <td width="7%" scope="row" class="text-xs-center">{{item.revenuemtdamount}}</td>
              ...
              <tr scope="row" v-for="(item,index) in hyderabad_branches" :key="index+item.branch" class="grey lighten-4">
                <td scope="row" class="text-xs-center">{{item.entity}}</td>
                <td width="10%" scope="row" class="text-xs-center">Hyderabad</td>
                <td width="10%" scope="row" class="text-xs-center">{{item.branch}}</td>
                <td width="7%" scope="row" class="text-xs-center">{{item.ftdopdrev}}</td>
                <td width="7%" scope="row" class="text-xs-center">{{item.mtdopdrev}}</td>
                <td width="7%" scope="row" class="text-xs-center">{{item.advise}}</td>
              ...
              <tr scope="row" v-for="(item,index) in kerla_branches" :key="index+item.branch" class="grey lighten-4">
                <td width="10%" scope="row" class="text-xs-center">{{item.entity}}</td>
                <td width="10%" scope="row" class="text-xs-center">Kerla</td>
                <td width="10%" scope="row" class="text-xs-center">{{item.branch}}</td>
                <td width="7%" scope="row" class="text-xs-center">{{item.ftdopdrev}}</td>
                <td width="7%" scope="row" class="text-xs-center">{{item.mtdopdrev}}</td>
                <td width="7%" scope="row" class="text-xs-center">{{item.advise}}</td>
              ...
              <tr scope="row" v-for="(item,index) in madhyapradesh_branches" :key="index+item.branch" class="grey lighten-4">
                <td width="10%" scope="row" class="text-xs-center">{{item.entity}}</td>
                <td width="10%" scope="row" class="text-xs-center">Madhyapradesh</td>
                <td width="10%" scope="row" class="text-xs-center">{{item.branch}}</td>
                <td width="7%" scope="row" class="text-xs-center">{{item.ftdopdrev}}</td>
                <td width="7%" scope="row" class="text-xs-center">{{item.mtdopdrev}}</td>
                <td width="7%" scope="row" class="text-xs-center">{{item.advise}}</td>
...
export default {
  data: () => ({
    ...
    json_fields: {
      ...
      "MTD": "mtdopdrev",
      "Advised": "advise",
      "RevenueFTDCount": "revenueftdcount",
      "RevenueMTDCount": "revenuemtdcount",
      "Target": "target",
      "Tar Ach%": "revenuetargetachived",
      "RevenueFTDAmount": "revenueftdamount",
      "RevenueMTDAmount": "revenuemtdamount"
  ...
  methods: {
    ...
    apiRequestUsageTracker(date) {
      ...
      if (date !== null) {
        ...
        this.isLoading = true;
        this.$http
          //.get(`https://scm.dragarwal.com/api-usage-tracker/${date}`)
