  ...
  created() {
    serverBus.$on("changeComponent", component => {
      ...
      if (this.userType == 'group') {
        ...
        this.tabItems = ['Domestic', 'Group', 'Trigger Email', 'Fetch Data', 'E-Recipients', 'FTD List', 'Exchange Rates', 'Cogs Vs Revn', 'Dashboard', 'NewOPD', 'Optical', 'Discount', 'Collection', 'AVA-Magic50', 'Newconsultation', 'AVA-Demo',
          'CogsVariance', 'Cogsdata', 'StockLedger'
        ];
