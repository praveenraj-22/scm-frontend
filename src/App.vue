  ...
  created () {
	...
	if(this.userType=='group'){
		if(this.userId==103390){
 		  ...
 		  this.tabItems = ['Domestic','Group','Cogs Vs Revn','Dashboard','NewOPD','Optical','Discount','Collection','AVA-Magic50','Newconsultation','CogsVariance']
	    ...
	    if(this.userId=='itteamch' || this.userId=='104608' || this.userId=='101248' || this.userId=='106000' || this.userId=='104786' || this.userId=='100952' ){
			this.tabItems = ['Domestic', 'Cogs Vs Revn', 'NewOPD', 'DRT','Petty Cash',"TPA"]
		}else{
		   this.tabItems = ['Domestic', 'Cogs Vs Revn', 'NewOPD', 'DRT',"TPA"]
		}
	    ...
	    if(this.userId=='itteamsch' || this.userId=='101506' || this.userId=='100552' || this.userId=='100078' || this.userId=='100405'){
		   ...
		   this.tabItems = ['Domestic', 'Cogs Vs Revn', 'NewOPD', 'DRTApproval']
		}
